...
namespace CustomSwitchDemo.Controls
{
    ...
    public partial class MySwitch : ContentView
    {
        ...
        private static BindableProperty TextColorProperty = BindableProperty.Create(
         nameof(TextColor), typeof(Color), typeof(MySwitch), Color.Black,
            BindingMode.OneWay, propertyChanged: TextColorPropertyChanged);

        private static void TextColorPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var control = (MySwitch)bindable;
            control._label.TextColor = (Color)newValue;
        }
